...
class ExcelController extends Controller
{
     ...
     * 渠道价调整 20201109
     */
    public function actionSkuChannelPrice20201109() {
        $inputFileName = $this->getPath() . "/models/excel/sku-price-channel-20201109.xlsx";
        $outfile = $this->getPath() . '/models/json/sku-channel-price-adjust20201109.json';
        try {
            $spreadsheet = IOFactory::load($inputFileName);
            $sql = '[';
            file_put_contents($outfile, $sql);
